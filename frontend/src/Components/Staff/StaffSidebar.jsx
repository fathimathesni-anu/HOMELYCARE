...
const menuItems = [
  ...
  { name: 'Patients', icon: UserGroupIcon, path: '/staff/patients' },
  { name: 'Doctors', icon: UserIcon, path: '/staff/doctors' },
  { name: 'Staff', icon: ClipboardDocumentListIcon, path: '/staff/staff' },
  { name: 'Tasks', icon: ClipboardIcon, path: '/staff/tasks' },
  { name: 'Blood Bank', icon: HeartIcon, path: '/staff/blood-bank' },
  { name: 'Chat', icon: ChatBubbleLeftEllipsisIcon, path: '/staff/chat' },
  { name: 'Notifications', icon: BellIcon, path: '/staff/notifications' },
  { name: 'Feedback', icon: PencilSquareIcon, path: '/staff/feedback' },
];
